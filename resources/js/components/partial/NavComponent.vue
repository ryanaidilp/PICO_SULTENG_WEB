    ...
    <nav ref="header" class="fixed top-0 w-full bg-white shadow-md main-nav-top">
      <div class="container flex flex-wrap items-center w-full pt-2 pb-3 mx-auto mt-0">
        <div class="w-1/2 pl-2 md:pl-0">
          <a
            class="flex flex-wrap text-gray-900 no-underline hover:no-underline"
            href="https://banuacoders.com/corona"
          >
            <div class="hidden mt-2 mr-3 md:mt-1 md:block">
              <img
                src="/corona/public/assets/images/logo.png"
                alt="PICO"
                class="w-5 h-5 md:w-10 md:h-10"
              />
            </div>
            <div>
              <span class="text-xs font-bold text-gray-800 md:text-lg">Pusat Informasi COVID-19</span>
              <br />
              <span class="text-xs text-gray-800 md:text-base">Provinsi Sulawesi Tengah</span>
            </div>
          </a>
        </div>
          ...
          <div class="w-full mx-auto">
            <ul class="flex flex-row text-center">
              <li class="flex-1 mr-3">
                <router-link
                  to="/corona"
                  class="block py-1 pl-1 text-gray-600 no-underline align-middle border-b-2 border-gray-800 hover:text-blue-500 hover:border-blue-500"
                >
              ...
              <li class="flex-1 mr-3">
                <router-link
                  to="/corona/kontak"
                  class="block py-1 pl-1 text-white text-gray-600 no-underline align-middle border-b-2 border-gray-800 hover:text-blue-500 hover:border-blue-500"
                >
