  ...
  <div class="w-auto mt-8">
    <div class="p-6 mx-4 text-white bg-blue-500 rounded-lg shadow-lg">
      ...
      <div class="flex flex-col w-full lg:flex-row">
        <p class="w-full mt-4 text-xs text-justify lg:w-3/4 lg:text-base">
          COVID-19 adalah penyakit yang disebabkan oleh
          <i>Novel Coronavirus 2019.</i>
          Gejala dari infeksi COVID-19 ini mirip dengan flu biasa. Meski begitu,
          COVID-19 masih memiliki fatalitas lebih tinggi. Penularan virus ini
          juga sangat cepat karena dapat berpindah dari orang ke orang. Bahkan
          kadang orang yang tertular tidak menunjukan gejala apapun.
          <br />
          <br />Apakah komiu bergejala? Ayo periksakan diri secara mandiri untuk
