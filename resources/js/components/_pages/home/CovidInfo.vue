        ...
        <div class="p-6 mx-4">
          ...
          <div class="flex flex-row w-full">
            <span class="w-auto mt-2 text-xs text-justify lg:text-lg">
              ...
              <span class="italic font-semibold"
                >Novel Coronavirus (2019-nCoV)</span
              >, jenis baru coronavirus yang pada manusia menyebabkan penyakit
              mulai flu biasa hingga penyakit yang serius seperti
              <span class="italic font-semibold"
                >Middle East Respiratory Syndrome (MERS)</span
              >
              dan Sindrom Pernapasan Akut Berat/
              <span class="italic font-semibold"
                >Severe Acute Respiratory Syndrome (SARS)</span
              >.
              <br />
              <br />Pada 11 Februari 2020,
              <span class="italic font-semibold"
                >World Health Organization (WHO)</span
              >
              mengumumkan nama penyakit yang disebabkan 2019-nCov, yaitu
          ...
          <div class="flex flex-row w-full">
            <span class="w-auto mt-2 text-xs text-justify lg:text-lg"
              ...
              tersebut akan dilakukan pemeriksaan laboratorium lebih lanjut
              untuk memastikan diagnosisnya.</span
            >
          </div>
...
export default {
  components: {
    CardLindungi: () => import("@/components/CardLindungi"),
    CardPeriksa: () => import("@/components/CardPeriksa"),
    Simptomps: () => import("@/components/Symptomps"),
