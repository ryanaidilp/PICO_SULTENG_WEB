    ...
    <div class="p-6 mx-4 bg-white rounded-lg shadow-lg">
      ...
      <div class="flex content-center justify-center w-full mt-2">
        <a
          ...
          href="https://github.com/RyanAidilPratama/Dashboard-COVID-19-Sulawesi-Tengah"
          target="_blank"
        ...
        >
          <svg id="icon-instagram" class="h-6 fill-current" viewBox="0 0 32 32">
            <title>Follow kami di Instagram</title>
            <path
        ...
        >
          <svg class="h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
            <title>Like kami di Facebook</title>
