...
export default {
  ...
  methods: {
    ...
    changeGroupJenisKelamin (stat) {
      ...
      if (stat === 'PDP') {
        tempJenisKelaminPria = parseInt(this.jsonDataRekapitulasiSulteng.pdp_total_per_gender.laki_laki)
        tempJenisKelaminWanita = parseInt(this.jsonDataRekapitulasiSulteng.pdp_total_per_gender.perempuan)
        tempJenisKelaminNull = parseInt(this.jsonDataRekapitulasiSulteng.pdp_total) - parseInt(tempJenisKelaminPria + tempJenisKelaminWanita)
        if (tempJenisKelaminNull < 0) {
          tempJenisKelaminNull = 0
        }
      
      } else if (stat === 'Positif') {
        tempJenisKelaminPria = parseInt(this.jsonDataRekapitulasiSulteng.positif_per_gender.laki_laki)
        tempJenisKelaminWanita = parseInt(this.jsonDataRekapitulasiSulteng.positif_per_gender.perempuan)
