...
class Stat extends Model
{
    ...
    {
        return PicoHelper::percentageValue($this->cumulative_positive, $this->cumulative_death);
    }
    ...
    {
        if ($this->id > 1) {
            $stat = Stat::whereBetween('id', [1, $this->id - 1])->sum('positive');
    ...
    {
        if ($this->id > 1) {
            $stat = Stat::whereBetween('id', [1, $this->id - 1])->sum('recovered');
    ...
    {
        if ($this->id > 1) {
            $stat = Stat::whereBetween('id', [1, $this->id - 1])->sum('death');
    ...
    {
        if ($this->id > 1) {
            $stat = Stat::whereBetween('id', [1, $this->id - 1])->sum('negative');
    ...
    {
        if ($this->id > 1) {
            $stat = Stat::whereBetween('id', [1, $this->id - 1])->sum('new_ODP');
    ...
    {
        if ($this->id > 1) {
            $stat = Stat::whereBetween('id', [1, $this->id - 1])->sum('new_PDP');
    ...
    {
        if ($this->id > 1) {
            $stat = Stat::whereBetween('id', [1, $this->id - 1])->sum('finished_PDP');
    ...
    {
        if ($this->id > 1) {
            $stat = Stat::whereBetween('id', [1, $this->id - 1])->sum('finished_ODP');
    ...
    {
        return PicoHelper::percentageValue($this->cumulative_positive, $this->cumulative_recovered);
    }
    ...
    public function getUnderTreatmentPercentageAttribute()
    {
        ...
        return PicoHelper::percentageValue($this->cumulative_positive, $underTreatment);
    }

    public function getDailyPositiveCaseAttribute()
    {
        return PicoHelper::averageCount($this->cumulative_positive, $this->day);
    }

    public function getDailyRecoveredCaseAttribute()
    {
        return PicoHelper::averageCount($this->cumulative_recovered, $this->day);
    }

    public function getDailyDeathCaseAttribute()
    {
        return PicoHelper::averageCount($this->cumulative_death, $this->day);
    }
}
