<template>
  <div class="w-full mt-4">
    <div class="p-6 mx-4 bg-white rounded-lg shadow-lg">
      <h3 class="text-xl font-bold lg:text-2xl">Lindungi Diri dan Orang Lain</h3>
      <div class="flex flex-row w-full">
        ...
        <div class="flex-col justify-center hidden w-1/4 mx-2 my-auto rounded-lg md:flex lg:block sm:p-2 lg:mx-16">
          <img v-lazy="route('home')+'assets/images/wash_hands.png'" title="Cuci Tangan" alt="Cuci Tangan" class="object-contain" />
          <img v-lazy="route('home')+'assets/images/wear_mask.png'" title="Pakai Masker" alt="Pakai Masker" class="object-contain mt-6" />
        </div>
      </div>
