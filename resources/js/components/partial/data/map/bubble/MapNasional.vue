      ...
      <div class="flex flex-wrap justify-center max-w-md mx-auto text-center">
        <div class="flex items-center mr-4">
          <input
            ...
            class="hidden"
            checked
            v-on:change="createCluster('Positif', positiveDataset, positiveColor)"
          />
          <label for="positif_nasional" class="flex items-center cursor-pointer">
        ...
        <div class="flex items-center mr-4">
          <input
            ...
            value="Sembuh"
            class="hidden"
            v-on:change="createCluster('Sembuh', recoveredDataset, recoveredColor)"
          />
        ...
        <div class="flex items-center mr-4">
          ...
          />
          <label for="meninggal_nasional" class="flex items-center cursor-pointer">
            <span class="inline-block w-4 h-4 mr-1 border rounded-full border-grey"></span>
            Meninggal
          </label>
        </div>
